...
import pandas as pd
# 描述：获取上市公司财务利润表数据
def income_wrapper(params: dict) :
    """
    利润表
...
# 描述：获取上市公司资产负债表数据
def balancesheet_wrapper(params: dict):
    """
    资产负债表
    接口：balancesheet，可以通过数据工具调试和查看数据。
    描述：获取上市公司资产负债表
    提示：当前接口只能按单只股票获取其历史数据，如果需要获取某一季度全部上市公司数据，请使用balancesheet_vip接口（参数一致）
...
# 描述：获取上市公司现金流量表数据
def cashflow_wrapper(params: dict):
    """
    现金流量表
    接口：cashflow，可以通过数据工具调试和查看数据。
    描述：获取上市公司现金流量表
    提示：当前接口只能按单只股票获取其历史数据，如果需要获取某一季度全部上市公司数据，请使用cashflow_vip接口（参数一致）。
...
# 描述：获取上市公司业绩预告数据
def forecast_wrapper(params: dict) :
    """
    业绩预告
    接口：forecast，可以通过数据工具调试和查看数据。
    描述：获取业绩预告数据
    提示：当前接口只能按单只股票获取其历史数据，如果需要获取某一季度全部上市公司数据，请使用forecast_vip接口（参数一致）。
...
# 描述：获取上市公司业绩快报数据
def express_wrapper(params: dict) :
    """
    业绩快报
    接口：express
    描述：获取上市公司业绩快报
    提示：当前接口只能按单只股票获取其历史数据，如果需要获取某一季度全部上市公司数据，请使用express_vip接口（参数一致）。
...
# 描述：获取上市公司分红送股数据
def dividend_wrapper(params: dict) :
    """
    分红送股
    接口：dividend
    描述：分红送股数据
    ...
    """
    return pro.dividend(**params)

# 描述：获取上市公司财务指标数据
def fina_indicator_wrapper(params: dict) :
    """
    财务指标数据
...
# 描述：获取上市公司主营业务构成数据
def fina_mainbz_wrapper(params: dict) :
    """
    主营业务构成
    接口：fina_mainbz
...
# 描述：获取上市公司财报披露计划数据
def disclosure_date_wrapper(params: dict) :
    """
    财报披露计划
    接口：disclosure_date
    描述：获取财报披露计划日期
